...
class Config():
    ...
    warmup_tokens = 512 * 1  # these two numbers come from the GPT-3 paper, but may not be good defaults elsewhere
    final_tokens = 260e1  # (at what point we reach 10% of original LR)
